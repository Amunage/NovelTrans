...
MODEL_CANDIDATES = [
    {
        ...
        "label": "26B Q5_K_M",
        "summary": "고품질 우선, VRAM 24GB 이상 GPU에 적합합니다.",
        "min_vram_gb": 24.0,
        "min_ram_gb": 48.0,
    },
    {
        ...
        "label": "26B Q4_K_M",
        "summary": "균형형이며 VRAM 16GB 환경에서는 다소 빡빡할 수 있습니다.",
        "min_vram_gb": 18.0,
        "min_ram_gb": 32.0,
    },
    {
        ...
        "label": "26B IQ4_XS",
        "summary": "VRAM 16GB 전후 GPU에서 가장 무난한 권장값입니다.",
        "min_vram_gb": 14.0,
        "min_ram_gb": 24.0,
    },
    {
        ...
        "label": "E4B Q6_K",
        "summary": "VRAM 12GB 전후 GPU에서 E4B 상급 품질을 노릴 때 적합합니다.",
        "min_vram_gb": 10.0,
        "min_ram_gb": 18.0,
    },
    {
        ...
        "label": "E4B Q4_K_M",
        "summary": "E4B 기본값으로 VRAM 8GB 전후 GPU에서 용량과 품질 균형이 가장 무난합니다.",
        "min_vram_gb": 6.0,
        "min_ram_gb": 12.0,
    },
    {
        ...
        "label": "E4B IQ4_XS",
        "summary": "E4B 경량 권장값으로 VRAM 여유가 적을 때 유리합니다.",
        "min_vram_gb": 5.0,
        "min_ram_gb": 10.0,
    },
]
